...
<div class="mx-auto max-w-6xl px-6 py-5 pb-12">
  <header class="flex items-center justify-between gap-4">
    ...
    <a
      href="https://github.com/Ekiiiim/Merkle-Patricia-Trie"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="View source on GitHub"
      title="View source on GitHub"
      class="shrink-0 rounded-md p-1 text-(--muted) transition-colors hover:text-(--text) focus-visible:outline-2 focus-visible:outline-(--accent)"
    >
      <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" class="size-7">
        <path
